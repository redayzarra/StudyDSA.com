...
const WelcomeCard = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="w-full mt-[55px] min-h-[200px] backdrop-blur-[15px] border-[1px] shadow-2xl shadow-black rounded-md bg-black/[.35] border-t-[1px] border-neutral-800/[.35] p-6">
